# The migration fiel gives instructions to Rails to change the structure of the database. By structure we mean things like: tables (creating / deleting), indexes, contraints..etc
# Note that the imgration it self is not the database. it is an instruction set to change the database. it will exxecute a query once you run:
# rails db:migrate
# or
#rails db:rollback
