...
class Question < ApplicationRecord
  ...
  #dependent: :nullify will update the `question_id` field to `null` in all the asssociated answers before deleting the question when you call `question.destroy`
